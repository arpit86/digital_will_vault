...
public class BlockStructureWithMultiple {
	...
	private String hash;
	private long nonce;
	private BlockStructureWithMultiple nextBlockStructure;
	private MerkleTree merkleTree;
	
	//Block constructor
	public BlockStructureWithMultiple(int blockNumber) {
	...
	public BlockStructureWithMultiple getNextBlockStructure() {
		return nextBlockStructure;
	}

	public void setNextBlockStructure(BlockStructureWithMultiple nextBlockStructure) {
	...
	private String mineBlockWithMultiple(String prevHash) {
	 ...
	 */
	public void setBlockHash(BlockStructureWithMultiple parentBlock) {
		if(parentBlock != null) {
		...
		buildMerkleTree();
		this.setHash(mineBlockWithMultiple(this.previousHash));
	}
	...
	public boolean verifyBlockChainValidity(String prevHash) {
		...
		String blockHash = mineBlockWithMultiple(prevHash);
